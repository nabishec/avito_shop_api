...
func MigrationsUp(db *sqlx.DB, dsn string) error {
	const op = "internal.storage.db.migrations.MigrationsUp()"
...
func MigrationsDown(db *sqlx.DB, dsn string) error {
	const op = "internal.storage.db.migrations.MigrationsDown()"
...
func connectionForMigration(dsn string) (*sqlx.DB, error) {
	const op = "internal.storage.db.migrations.connectionForMigration()"
...
func newMigrationDriver(db *sql.DB) (database.Driver, error) {
	const op = "internal.storage.db.migrations.newMigrationDriver()"
...
func newMigrationInstance(driver database.Driver) (*migrate.Migrate, error) {
	const op = "internal.storage.db.migrations.newMigrationInstance()"
...
func startMigrationUp(migration *migrate.Migrate) error {
	const op = "internal.storage.db.migrations.startMigrationUp()"
...
func startMigrationDown(migration *migrate.Migrate) error {
	const op = "internal.storage.db.migrations.startMigrationDown()"
	err := migration.Down()
